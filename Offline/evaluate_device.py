...
from models.Audio_ResNet import get_audio_encoder, LSTMTemporalEncoder, AudioTemporalEncoder, AudioModel
...
def load_models(args):
    ...
    for size in ['small', 'medium', 'large']:
        ...
        audio_temporal_encoder = AudioTemporalEncoder().to(args.device)
        audio_temporal_encoder.load_state_dict(audio_filtered_dict, strict=False)

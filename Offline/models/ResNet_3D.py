...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, alpha, beta, stride=1, cdiv=2):
        ...
        layers = []
        layers.append(block(self.inplanes, planes, alpha, beta, stride, downsample, False, cdiv=cdiv, loop_id=self.loop_id))
...
class Video_Encoder(nn.Module):
    def __init__(self, model='resnet18', pretrain=True, feature_dim=512, num_classes=50):

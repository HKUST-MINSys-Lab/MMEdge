...
from models.Video_ResNet import MultiScaleTemporalShift 
...
class AudioModelLightweightEncoder(nn.Module):
    def __init__(self, input_len=19456, hidden_dim=64, num_layers=1, num_classes=50):
        super().__init__()

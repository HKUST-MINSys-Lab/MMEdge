...
if __name__ == '__main__':
    ...
    audio_model = AudioEncoderModel()
    video_model = Video_Encoder()
    fusion_model = MultiModalFusion()

    audio_pretrained_dict = torch.load('checkpoints/audio_only.pth')
    ...
    video_pretrained_dict = torch.load('checkpoints/video_only_3d.pth')
    ...
    # 训练
    train(models, train_loader, test_loader, criterion, optimizer, scheduler, device, epochs=epochs, save_path="./checkpoints/fusion_finetune_3D.pth")

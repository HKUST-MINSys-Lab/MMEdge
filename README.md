...
This repository provides the public release of [**MMEdge**](https://arxiv.org/abs/2510.25327v6), a real-time on-device multimodal inference framework based on pipelined sensing and encoding. Unlike traditional multimodal systems that wait for complete sensor inputs before inference, MMEdge decomposes data collection and computation into fine-grained sensing and encoding units, enabling fully pipelined and parallel execution across modalities.
...
✅ Paper: [https://arxiv.org/abs/2510.25327v6](https://arxiv.org/abs/2510.25327v6) \
✅ Demo Video: [https://youtu.be/qRew7sT-iWw](https://youtu.be/qRew7sT-iWw)
